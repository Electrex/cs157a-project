...
router.get('/', async (req, res) => {
    try {
        ...
        // listings.forEach(listing => {
        //     const insertListingSQLQuery = `INSERT INTO Listings (vin, sellerID, price, listingDate) VALUES (?, ?, ?, ?)`;
        //     db.run(insertListingSQLQuery, [listing.vin, listing.sellerID, listing.price, listing.listingDate], function(err) {
        //         if (err) {
        //             return console.log(err.message);
        //         }
        //         listing.listingID = this.lastID;
